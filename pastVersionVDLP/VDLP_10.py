        ...
        while self.stopped == False:
            if self.connStatus == False:
                ...
                if self.disconnect:
                    ...
                    if indexPoll != -1 and indexGset != -1 and Gui.role == "teacher":
                        Gui.poll = True
                        Gui.pollState = 1
                    if Gui.poll:
                        if Gui.pollState == 1:
                    ...
                    elif Gui.role == "teacher":
                        if Gui.pollResult == 1 or Gui.pollResult == 2 or Gui.pollResult == 3:
                ...
                if self.disconnect:
                    ...
                    if self.connStatus == True:
                        ...
                        if Gui.role == "teacher" and pollContent != "":
                            Gui.pollState = 7
                            print("the poll result is ", pollContent)
